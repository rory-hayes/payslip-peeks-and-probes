...
const REQUIRED_MIGRATION = "20260828190000_confirm_review_line_items.sql";
...
const manualChecks = [
  "Apply the intended Supabase migrations through 20260828190000_confirm_review_line_items.sql and deploy the exact Edge Function revisions, including the server-owned reviewed-line-item confirmation, two-check lifetime quota, upload, original-link, checkout-return verification, payment-webhook, and account-deletion functions.",
