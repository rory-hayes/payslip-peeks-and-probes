...
const REQUIRED_MIGRATION = "20260828200000_confirm_review_supporting_details.sql";
...
const manualChecks = [
  "Apply the intended Supabase migrations through 20260828200000_confirm_review_supporting_details.sql and deploy the exact Edge Function revisions, including the server-owned reviewed-detail confirmation, two-check lifetime quota, upload, original-link, checkout-return verification, payment-webhook, and account-deletion functions.",
