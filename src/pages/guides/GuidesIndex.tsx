...
import { FileText, TrendingDown, AlertCircle, GitCompare, Flag, Globe, ArrowRight } from 'lucide-react';
...
const coreGuides = [
  ...
  { title: 'Common Payslip Mistakes', desc: 'Common things to check on UK and Ireland payslips, and how to spot them.', to: '/guides/common-payslip-mistakes', icon: AlertCircle },
...
const GuidesIndex = () => {
  useEffect(() => {
    applySeo(marketingSeoFor('/guides'));
  }, []);
